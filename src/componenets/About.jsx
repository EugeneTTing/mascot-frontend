            ...
            <div className="form-page">
                ...
                <div className="question-wrapper">
                    <div className="select-question explained">
                        <label htmlFor="alcohol">Select the option which best describes your <span className="tooltip" data-text={alcohol}>level of alcohol consumption</span>. <span className="material-symbols-rounded">help</span></label>
                        <select 
                            id="alcohol" 
                            name="alcohol"
                            value={data.alcohol}
